...
public class UserDetailController {
	...
	/** ユーザー更新処理 */
			...
			public String updateUser(Model model, @ModelAttribute 
		    @Validated UserDetailForm form, BindingResult bindingResult) {
			// 入力チェック
				 if (bindingResult.hasErrors()) {
//				model.addAttribute("errors", bindingResult.getAllErrors()); //AI
				 return	 "edit" ;
			 }					
